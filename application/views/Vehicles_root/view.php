                  ...
                  <tr style="border:ridge;font-weight: bold;">
                    ...
                    <input type="hidden" name="item_id[]" value="<?php echo $value->item_id; ?>">
                     ...
                     <td style="width: 150px;">
                         <input type="text" autofocus class="form-control" name="weight[]" id="weight<?php echo $i; ?>" value="<?php echo $value->weight; ?>">
                       
                        </td>

                          <td style="width: 150px;">
                         <input type="text" autofocus class="form-control" name="unit[]" id="unit<?php echo $i; ?>" value="<?php echo $value->unit; ?>">
                       
                        </td>

                          <td style="width: 150px;">
                         <input type="text" autofocus class="form-control" name="tweight[]" id="tweight<?php echo $i; ?>" value="<?php echo $value->tweight; ?>">
                       
                        </td>

                         <td style="width: 150px;border:ridge;"><!---hds month pricipal-->
                           <input type="text" autofocus class="form-control" name="damage_weight[]" id="damage_weight<?php echo $i; ?>" value="<?php echo $value->damage_weight; ?>">
                        </td>

                         <td style="width: 150px;border:ridge;"><!---hds month pricipal-->
                           <input type="text" autofocus class="form-control" name="balance[]" id="balance<?php echo $i; ?>" value="<?php echo $value->balance; ?>">
                        </td>
