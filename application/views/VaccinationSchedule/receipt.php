  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Vaccination Receipt</li>
      </ol>
    </section>
                                            ...
                                            <tr>
                                                <td style=" padding: 5px 0;">
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                        <tbody><tr>
                                                            <td>Farmer Name</td>
                                                            <td style="font-weight: bold;" class="alignright"><?php echo $records->member_name; ?></td>
                                                        </tr>
                                                       
                                                        <tr>
                                                            <td style="padding-top: 20px;">Vaccination Name</td>
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><?php echo $records->vaccination_name; ?></td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <td style="padding-top: 20px;">Schedule Vaccine Dose</td>
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><?php echo $records->schedule_vaccine_dose; ?></td>
                                                        </tr>
                                                        
                                                         <tr>
                                                            <td style="padding-top: 20px;">schedule_vaccine_date</td>
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><?php echo date('d-m-Y',strtotime($records->schedule_vaccine_date)); ?></td>
                                                        </tr>
