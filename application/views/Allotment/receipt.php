  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Allotment Receipt</li>
      </ol>
    </section>
                                                ...
                                                <td style=" padding: 5px 0;">
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><?php echo $records->product_name; ?></td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <td style="padding-top: 20px;">Total Quantity</td>
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><?php echo $records->allot_quantity." "."Nos"; ?></td>
                                                        </tr>
                                                        
                                                         <tr>
                                                            <td style="padding-top: 20px;">Total Weight</td>
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><?php echo $records->allot_weight." ".$records->unit_name; ?></td>
                                                        </tr>
