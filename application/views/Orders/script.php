  ...
  $(function () {
    ...
    $table = $('#classinfo_table').DataTable( {
      ...
      "createdRow": function ( row, data, index ) {
        ...
        if(data['status']==1)
        {
          $('td',row).eq(3).html('COMPLETED');
        }
        else
        {
          $('td',row).eq(3).html('PENDING');
        }
        $('td', row).eq(4).html('<center><a href="<?php echo base_url();?>index.php/Orders/edit/'+data['order_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['order_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
      },
      "columns": [
