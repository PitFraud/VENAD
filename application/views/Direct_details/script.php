...
$(function () {
  ...
  $table = $('#direct_table').DataTable( {
    ...
    "createdRow": function ( row, data, index ) {
      ...
      $('td', row).eq(11).html('<center><a href="<?php echo base_url();?>index.php/Direct_details/edit/'+data['d_details_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['d_details_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
    ...
    "columns": [
      ...
      // { "data": "d_details_photo", "orderable": false },
      ...
      { "data": "d_details_dob", "orderable": false },
