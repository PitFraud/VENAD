  ...
  $(function () {
    ...
    $table = $('#customer_table').DataTable({
        ...
        "createdRow": function ( row, data, index ) {
			...
			$('td', row).eq(7).html('<center><a href="<?php echo base_url();?>Customer/edit/'+data['cust_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['cust_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
		},
