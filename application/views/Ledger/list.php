...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
        <div class="box">
        	  <form name="" method="post" action="<?php echo base_url(); ?>Ledger/getledger">
            ...
            <input type="hidden" id="response" value="<?php echo $this->session->flashdata('response');?>" />
			  ...
			  <div class="col-md-2"></div>
               ...
               <option  <?php if(isset($head)){if($head==1){echo "selected";}} ?> value="1">PURCHASE</option>

                <option  <?php if(isset($head)){if($head==2){echo "selected";}} ?> value="2">SALE</option>
            
             <option  <?php if(isset($head)){if($head==3){echo "selected";}} ?> value="3">RECEIPTS & PAYMENTS</option>

                <option  <?php if(isset($head)){if($head==4){echo "selected";}} ?> value="4">SALARY</option>
              <option  <?php if(isset($head)){if($head==5){echo "selected";}} ?> value="5">ADVANCE</option>
					</select>
				</div><!-- /input-group -->
				</div>
			<div class="col-md-4">
