                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-control" name="vehicle_type">
                        <?php foreach ($vehicle_types as $type) : ?>
                          <option <?php if (isset($records->vehicle_type_fk)) {
                                    if ($records->vehicle_type_fk == $type->type_id) {
                                      echo "selected";
                                    }
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-control" name="group">
                        <?php foreach ($vehicle_groups as $group) : ?>
                          <option <?php if (isset($records->vehicle_group_fk)) {
                                    if ($records->vehicle_group_fk == $group->group_id) {
                                      echo "selected";
                                    }
