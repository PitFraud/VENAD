  ...
  $(function () {
    ...
    $table = $('#sale_details_table').DataTable( {
        ...
        "createdRow": function ( row, data, index ) {
            ...
            $('td', row).eq(9).html('<center><a target ="_blank"  href="<?php echo base_url();?>Sale/invoiceview/'+data['invoice_number']+'"><i class="fa  fa-file iconFontSize-medium" ></i></a></center>');
            },
        ...
        "columns": [
            ...
            { "data": "member_shop", "orderable": false },
            { "data": "sale_date", "orderable": false },
            { "data": "customer_paid_amt", "orderable": false },
            { "data": "customer_old_bal", "orderable": false },
