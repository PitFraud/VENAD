  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		...
		<li><a href="<?php echo base_url();?>Receipt"><i class="fa fa-dashboard"></i> Back to list</a></li>
	  </ol>
    </section>
	<!-- Main content -->
              ...
              <!-- radio -->
			   ...
			   <input type="hidden" name="rece_id" value="<?php if(isset($records->receipt_id)) echo $records->receipt_id ?>"/>
				...
				<div class="form-group">
					...
					<div class="col-sm-4">
						<input type="date"   name="created_date" id="created_date" class="form-control" placeholder="" value="<?php if(isset($records->created_date)){ echo $records->created_date; }?>"/>
					</div>
				</div>
				<div class="form-group">
					...
					<label for="customer_email" class="col-sm-2 control-label"> Received From <span style="color:red">*</span></label>
					<div class="col-sm-4">
