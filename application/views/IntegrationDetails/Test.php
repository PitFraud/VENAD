...
class Test extends MY_Controller {
	...
	public function modifyTable(){
		...
		//$query=$this->dbforge->modify_column('tbl_receive_back', $fields);
	...
	public function add_colum(){
		...
		//$query=$this->dbforge->add_column('tbl_receive_back', $fields);
	...
	public function alterTable(){
		...
		//$query = $this->dbforge->add_column('tbl_receive_back',$fields);  //uncomment this line
