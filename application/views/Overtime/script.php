    ...
    $table = $('#category_table').DataTable( {
        ...
        "createdRow": function ( row, data, index ) {
           ...
           $table.column(0).nodes().each(function(node,index,dt){
            ...
            $('td', row).eq(5).html('<center><a href="<?php echo base_url();?>index.php/Overtime/edit/'+data['overtym_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['overtym_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
        },
