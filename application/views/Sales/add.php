...
<style>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
     ...
     <!-- Main content -->
 <form class="form-horizontal" method="POST" action="<?php echo base_url();?>Sales/add">
                ...
                <div class="box-body">
                    ...
                    <br>
                     <h4><b>TOTAL BILL DETAILS</b></h4>
          					<div class=" pull-left" >
          						<div class="pull-left" ><h4>Old Balance &nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b><span id="old_bal" style="color:blue;">0</span><input type="hidden" id="old_bal_" name="old_bal" ></b></h4></div></br>
          						<div class="pull-left" ><h4>Paid Amount &nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input style="border: 1px solid #bfc9c2;width: 135px;" type="text" id="payng_amt" name="paid_amt" value="0"></h4></div>
          					</div>
          					<div class="NetTotalAmount pull-right" >
          						<div class="pull-right" ><h4>Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b><span id="grand_total">0</span><input type="hidden" name="net_total" id="net_total" value="0"/></b></h4></div></br>
          						<div class="pull-right" ><h4>Net Total &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="net_bal" style="color:red;">0</span><input type="hidden" id="netbal" /><input type="hidden" name="net_balance" id="net_balance" /></b></h4></div>
