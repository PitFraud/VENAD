                  ...
                  <input type="hidden" name="product_id" value="<?php if(isset($records->product_id)) echo $records->product_id ?>"/>
                   <input type="hidden" name="product_stock" value="<?php if(isset($records->product_stock)) echo $records->product_stock ?>"/>
                     ...
                     <div class="form-group row">
                        ...
                        <div class="col-md-6">
                          <label class="fsize">Product Type</label>
                          <select name="product_type"  id="product_type" class="form-control" style="font-weight: bold;" onChange="getsubcat();">
                            <option value="">-SELECT-</option>
                             <option <?php if(isset($records->product_type)){if($records->product_type==1){echo "selected";}} ?> value="1">Chicks</option>
                             <option <?php if(isset($records->product_type)){if($records->product_type==2){echo "selected";}} ?> value="2">Poultry Equipment</option>
                              <option <?php if(isset($records->product_type)){if($records->product_type==3){echo "selected";}} ?> value="3">Chicken Vaccines</option>
                               <option <?php if(isset($records->product_type)){if($records->product_type==4){echo "selected";}} ?> value="4">Medicines</option>
                               <option <?php if(isset($records->product_type)){if($records->product_type==5){echo "selected";}} ?> value="5">Poultry Feed</option>
                          </select>
                        </div>
                        <div class="col-md-6">
