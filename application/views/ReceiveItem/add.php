              ...
              <div class="panel panel-danger">
                ...
                <select class="form-control" name="allotment" id="allotment_id">
                  <?php foreach ($allotment_details as $allotment): ?>
                    <option <?php if(isset($records->rec_allotment_fk)){ if($records->rec_allotment_fk==$allotment->allot_id){echo "selected";}} ?> value="<?php echo $allotment->allot_id; ?>"><?php echo $allotment->member_name." - ".$allotment->product_name." - ".$allotment->allot_weight." ".$allotment->unit_name." - ".$allotment->allotment_date; ?></option>
                  <?php endforeach; ?>
                </select>
              </div>
               ...
               <div class="form-group row">
                ...
                <div class="form-group">
                  <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="intg_code" autofocus required style="text-transform:uppercase" value="<?php if(isset($records->rec_code)) echo $records->rec_code ?>">
                  </div>
                </div>
                </div>
              </div>
