  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="<?php echo base_url();?>index.php/attendance/add"><i class="fa fa-dashboard"></i> Back to Add</a></li>
        ...
        <div class="input-group margin">
          <div class="input-group-btn">
            ...
            <select class="form-control" id="month" name="month">
                ...
                <option value="09">SEPTEMBER</option><option value="10">OCTOBER</option><option value="11">NOVEMBER</option><option value="12">DECEMBER
                </option>
            </select>
        </div><!-- /input-group --> 
        </div>
