	...
	<h4><center><strong>PAY SLIP</strong></center></h4>
		<table class="" border="1" width="100%" cellpadding="2" cellspacing="0">
			<tr>
				...
				<td colspan="2"><?php echo $records->emp_name; ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td align="right" colspan="2"><strong>NET PAY</strong></td>
				<td align="right" colspan="2"><strong>Rs. <?php echo $records->payroll_salary; ?></strong></td>
			</tr>
			<tr>
				<td colspan="2"><strong></br></br></br>Date : <?php if(isset($records->payroll_salarydate)){ $sl_date = str_replace('-', '/', $records->payroll_salarydate); $sl_date =  date("d/m/Y",strtotime($sl_date));  echo $sl_date; }?></strong></td>
