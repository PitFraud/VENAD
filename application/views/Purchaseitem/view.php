      ...
      <div class="row">
        ...
        <th>Net Total</th>
			...
			<tr>
				...
				<td><?php echo $records[$i]->raw_item; ?></td>
				<td><?php echo $records[$i]->purchase_quantity." ".$records[$i]->raw_unit; ?></td>
				<td>Rs.<?php echo $records[$i]->purchase_price; ?></td>
				<td><?php echo $records[$i]->discount_price; ?>%</td>
				<td><?php echo $records[$i]->purchase_igst; ?>%</td>
				<td>Rs.<?php echo $records[$i]->total_price; ?></td>
        <td>Rs.<?php echo $records[$i]->purchase_netamt; ?></td>
				<td>&nbsp;&nbsp;&nbsp;<?php if(($records[$i]->stockstatus) == 0){?>
				<a href="<?php echo base_url();?>Purchase/purc/<?php echo $records[$i]->purchase_id; ?>"><i class="fa fa-edit iconFontSize-medium"></i></a>&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>Purchase/delete/<?php echo $records[$i]->purchase_id; ?>"><i class="fa fa-trash-o iconFontSize-medium" ></i></a><?php } 
				else{ ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url();?>Purchase/"><i class="fa fa-refresh  iconFontSize-medium"></i></a>
				<?php } ?></td>
            </tr>
