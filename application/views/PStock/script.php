<script>
  ...
  $(function() {
    ...
    $table = $('#classinfo_table').DataTable({
      ...
      "bDestroy": true,
      "ajax": {
        "url": "<?php echo base_url(); ?>PStock/get/",
        "type": "POST",
        "data": function(d) {
        }
      },
      "createdRow": function(row, data, index) {
        ...
        $('td', row).eq(6).html('<center><a class="btn btn-primary" href="<?php echo base_url() ?>PStock/receipt/'+data['item_id']+'">Receipt</a></center>');
      },
      "columns": [{
          "data": "item_status",
          "orderable": false
        ...
        {
          "data": "item_latest_qr", render : function(data,type,full,meta){
            if(data!=null){
            return '<img onclick="myFunction(this);" src="data:image/png;base64,'+data+'" height=\"50\" width=\"50\"/>';
          }else{
            return "No QR Found!";
          }
          }
        ...
        {
          "data": "item_latest_barcode", render : function(data,type,full,meta){
            if(data!=null){
            return '<img onclick="myFunction(this);" src="data:image/png;base64,'+data+'" height=\"50\" width=\"50\"/>';
          }else{
