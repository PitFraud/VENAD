...
<ul class="treeview-menu ">
    ...
    <li class="<?php if($this->uri->segment(1)=="Product/itemCategory"){echo "active";}?>" ><a  href="<?php echo base_url();?>Product/itemCategory"><i class="fa fa-circle-o"></i> <span>Item Category</span></a></li>
...
<ul class="sidebar-menu" id="navi">
    <li class="<?php if($this->uri->segment(1)=="Reminders"){echo "active";}?>" >
      <a  href="<?php echo base_url();?>Reminders"><i class="fa fa-bell"></i> <span>Reminders</span></a></li>
</ul>
