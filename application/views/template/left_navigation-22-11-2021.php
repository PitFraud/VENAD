      ...
      <li class="<?php if($this->uri->segment(1)=="Region"){echo "active";}?>" ><a  href="<?php echo base_url();?>Region"><i class="fa fa-circle-o"></i> <span>Region</span></a></li>
			...
			if($this->uri->segment(1)=='Deposit')
              ...
              <ul class="treeview-menu">
				...
				<li class="<?php if($this->uri->segment(1)=="Deposit" && $this->uri->segment(2)=='viewgroup'){echo "active";}?>" ><a href="<?php echo base_url();?>Deposit/viewgroup"><i class="fa fa-circle-o"></i><span>Add Deposit</span></a></li>
             	<li class="<?php if($this->uri->segment(1)=="Deposit" && $this->uri->segment(2)==''){echo "active";}?>" ><a href="<?php echo base_url();?>Deposit"><i class="fa fa-circle-o"></i><span>View Deposits</span></a></li>
			</ul>
			</li>	
        ...
        <li class="<?php if($this->uri->segment(1)=="Preport"){echo "active";}?>" >
		    ...
		    ?>">
				...
				<ul class="treeview-menu ">
		            <li class="<?php if($this->uri->segment(1)=="GDeposit" && $this->uri->segment(2)==''){echo "active";}?>" ><a href="<?php echo base_url();?>GDeposit"><i class="fa fa-circle-o"></i><span>Add Deposit</span></a></li>
		             <li class="<?php if($this->uri->segment(1)=="GDeposit" && $this->uri->segment(2)=='viewlist'){echo "active";}?>" ><a href="<?php echo base_url();?>GDeposit/viewlist"><i class="fa fa-circle-o"></i><span>View Deposits</span></a></li>
		    ...
		    ?>">
          <a><i class="fa fa-bank"></i><span>Group Loan</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
		<ul class="treeview-menu ">
			...
			if($this->uri->segment(2)=="UPNRMLoan")
              ...
              <a href="#"><i class="fa fa-circle-o"></i> Repayment History
                <span class="pull-right-container">
                  <i class="fa fa-angle-left pull-right"></i>
                </span>
              </a>
        ...
        <li class="<?php if($this->uri->segment(1)=="dashboard"){echo "active";}?>" ><a  href="<?php echo base_url();?>dashboard"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li class="<?php if($this->uri->segment(1)=="RPanchayath"){echo "active";}?>" ><a  href="<?php echo base_url();?>RPanchayath"><i class="fa fa-globe"></i> <span>Unit</span></a></li>
