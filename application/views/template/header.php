...
<div class="wrapper">
  ...
  <header  class="main-header">
    ...
    <!-- Logo -->
    <a style="background-color:#cb262d; height: 55px;" class="logo">
      <!-- mini logo for sidebar mini 50x50 pixels -->
      <span class="logo-mini" style="font-size: 13px;"><b>VENAD</b></span>
   ...
   <!-- <nav style="background-color:#c2c2a3"  class="navbar navbar-static-top" role="navigation">-->
        ...
        <ul>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header" style="background-color:#cb262d; ">
                <img src="<?php echo base_url();?>Images/logo.jpeg" class="img-circle" alt="User Image" style="width:150px;height:100px">
    ...
    <style>
      th { font-size: 16px; }
      td { font-size: 15px;  font-family: "Lucida Console", Courier, monospace;}
    </style>
  </header>
