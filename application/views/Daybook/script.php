  ...
  /*  $('#daybuk_date').datepicker({
    ...
    $('input[type="checkbox"].flat-red, input[type="radio"].flat-red').iCheck({
	 ...
	 $table = $('#enquiry_table').DataTable( {
        ...
        "bDestroy" : true,
        "ajax": {
            "url": "<?php echo base_url();?>GDaybook/get",
            "type": "POST",
            "data" : function (d) {
...
$(document).on('click','#search',function(){
		...
		if(daybuk_date){
		$.ajax({
            url:"<?php echo base_url();?>GDaybook/get_opening",
		...
		$.ajax({
            url:"<?php echo base_url();?>GDaybook/get_sum_",
			data:{daybuk_date:daybuk_date},
            type:'POST',
			dataType:"json",
            success:function(data){
...
$(document).ready(function(){
	$.ajax({
            url:"<?php echo base_url();?>GDaybook/get_sum",
            type:'POST',
			dataType:"json",
            success:function(data){
			    var opening = $('#opening').text();
