        ...
        <div class="col-md-4">
          ...
          <th style="border-color:#d4d6d5;">PAYMENTS</th>
                ...
                <tbody style="font-weight: bold;">
                 ...
                 <td style="border-color:#d4d6d5;"></td>
                  <td style="border-color:#d4d6d5;"><?php echo $rows1->salary; ?></td>
                </tr>
              <?php $sal=$sal+$rows1->salary;} ?> 
               ...
               <?php foreach($advance as $rows1){ ?>
                 ...
                 <td style="border-color:#d4d6d5;"></td>
                  <td style="border-color:#d4d6d5;"><?php echo $rows1->adv_amount; ?></td>
                </tr>
              ...
              <?php $purchase=$purchase+$rows1->pur_paid_amt;} ?>
                ...
                <?php foreach($feed as $rows1){ ?>
                  <tr>
                     <td style="border-color:#d4d6d5;"><?php echo date('d/m/Y',strtotime($rows1->created_at)); ?></td>
                   <td style="border-color:#d4d6d5;">Purchase Feeds from <?php echo $rows1->purchase_vendor_name; ?></td>
                 <td style="border-color:#d4d6d5;"></td>
                  <td style="border-color:#d4d6d5;"><?php echo $rows1->purchase_total_cost; ?></td>
                </tr>
