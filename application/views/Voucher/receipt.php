...
.invoices .invoice-items .total td {
  ...
  <section class="invoice">
                                                ...
                                                <td style=" padding: 5px 0;">
                                                    <table class="invoice-items" cellpadding="0" cellspacing="0" style="width: 100%;">
                                                        <tbody>
                                                          <tr>
                                                            <td>Voucher Date</td>
                                                            <td style="font-weight: bold;" class="alignright"><?php echo $records->voucher_date; ?></td>
                                                        </tr>
                                                       
                                                        <tr>
                                                            <td style="padding-top: 20px;">Voucher Head</td>
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><?php echo $records->vouch_head; ?></td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <td style="padding-top: 20px;">Amount</td>
                                                            <td style="padding-top: 20px;font-weight: bold;" class="alignright"><i class="fa fa-inr"></i> <?php echo $records->voucher_amount; ?></td>
                                                        </tr>
                                                        
                                                         <tr>
                                                            <td style="padding-top: 20px;">Paid To</td>
    ...
    font-weight: 700;padding-top: 20px;">
                                                            ...
                                                            <td style="padding-top: 20px;" class="alignright"><i class="fa fa-inr"></i> <?php echo $records->voucher_amount ; ?></td>
                                                        </tr>
                                                    </tbody></table>
                                                </td>
                                            </tr>
