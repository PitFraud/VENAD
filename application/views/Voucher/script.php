...
$(document).on('change','#vouch_name',function(){
  ...
  $(function () {
    ...
    $table = $('#receipt_list').DataTable( {
       ...
       $('td', row).eq(6).html('<center><a href="<?php echo base_url();?>Voucher/receipt/'+data['voucher_id']+'"><i class="fa fa-file iconFontSize-medium" ></i></a></center>');
       
			$('td', row).eq(7).html('<center><a href="<?php echo base_url();?>Voucher/edit/'+data['voucher_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a>&nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['voucher_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
        },
