...
//            $('td',row).eq(0).html(index+1);
      ...
      $('td', row).eq(16).html('<center><a href="<?php echo base_url();?>index.php/Member/edit/'+data['member_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['member_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
      },
        "columns": [
            ...
            { "data": "area_of_shed", "orderable": false },
            { "data": "area_capacity", "orderable": false },
      			{ "data": "created_at", "orderable": false },
            { "data": "member_shop_name", "orderable": false },
            { "data": "member_shop_gst", "orderable": false },
