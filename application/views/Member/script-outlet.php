...
//            $('td',row).eq(0).html(index+1);
	 ...
	 if(data['member_img']=='Not uploaded')
      ...
      $('td', row).eq(12).html('<center><a href="<?php echo base_url();?>index.php/Member/getOutletPaymentDetails/'+data['member_id']+'"><i class="fa fa-print iconFontSize-medium" ></i></a></center>');
       $('td', row).eq(13).html('<center><a href="<?php echo base_url();?>index.php/Member/edit/'+data['member_id']+'"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete('+data['member_id']+')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
        ...
        "columns": [
            ...
            { "data": "member_outlet_code", "orderable": false },
