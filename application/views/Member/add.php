            ...
            <div class="box-body"><div class="col-lg-2"></div>
             ...
             <div class="panel panel-danger">
                ...
                <div class="panel-heading">
                  ...
                  <h3 class="panel-title"><b>NEW FARMER MEMBER</b></h3>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <label class="fsize">Member ID</label>
                ...
                <div class="col-md-6">
                  ...
                  <label class="fsize">Member Name</label>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <select name="member_gender" class="form-control">
                    ...
                    <option value="1" <?php if(isset($records->member_gender) && ($records->member_gender == "1")) { echo "selected";}?>>Male</option>

                    <option value="2" <?php if(isset($records->member_gender) && ($records->member_gender == "2")) { echo "selected";}?>>Female</option>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" data-pms-required="true" autofocus class="form-control" name="member_email"  value="<?php if(isset($records->member_email)) echo $records->member_email ?>">
                ...
                <div class="col-md-6">
                  ...
                  <input type="text" data-pms-required="true" autofocus class="form-control" name="member_pnumber"  value="<?php if(isset($records->member_pnumber)) echo $records->member_pnumber ?>">
                ...
                <div class="col-md-6">
                  ...
                  <select name="member_state" class="form-control" id="member_state">
                      ...
                      <?php foreach($state as $state){?>
                        ...
                        <option <?php if(isset($records->member_state)){if($records->member_state==$state->state_id){echo "selected";}} ?>  value="<?php echo $state->state_id; ?>"><?php echo $state->state_name; ?></option>
                  ...
                  <select name="member_district" class="form-control" id="member_district">
                     ...
                     <?php if(isset($records->member_district)){ ?>
                      ...
                      <?php foreach($district as $district){?>
                        ...
                        <option <?php if(isset($records->member_district)){if($records->member_district==$district->district_id){echo "selected";}} ?>  value="<?php echo $district->district_id; ?>"><?php echo $district->district_name; ?></option>
                  ...
                  <div class="col-md-6">
                    ...
                    <select name="member_panchayath" class="form-control" id="member_panchayath">
                      ...
                      <?php foreach($panchayath as $panchayath){?>
                        ...
                        <option <?php if(isset($records->member_panchayath)){if($records->member_panchayath==$panchayath->panchayath_id){echo "selected";}} ?>  value="<?php echo $panchayath->panchayath_id; ?>"><?php echo $panchayath->panchayath_name; ?></option>
             ...
             <div class="form-group row">
               ...
               <div class="col-md-6">
                 ...
                 <label class="fsize">Area of Shed(Sq.FT)</label>

                 <input type="number" class="form-control" name="member_area_of_shed" value="">
               ...
               <div class="col-md-6">
                 ...
                 <input type="number" class="form-control" name="member_capacity" value="">
             ...
             <div class="form-group row">
                ...
                <div class="col-md-6">
                  ...
                  <select name="member_type" class="form-control" id="shareholder">
                    ...
                    <option value="0" <?php if(isset($records->member_type) && ($records->member_type == "0")) { echo "selected";}?>>Other Farmer Member</option>

                    <option value="5" <?php if(isset($records->member_type) && ($records->member_type == "0")) { echo "selected";}?>>Shops</option>

                    <option value="6" <?php if(isset($records->member_type) && ($records->member_type == "6")) { echo "selected";}?>>Customers</option>
                ...
                <?php } else if(@$records->member_type == "2"){ ?>

                <div class="col-md-6" id="outlet_code" style="display: block;">

                  <label for="">Outlet Code</label>

                  <input type="text" class="form-control" name="outlet_code" placeholder="Enter Outlet Code" value="<?php if(isset($records->member_outlet_code)) echo $records->member_outlet_code ?>">

                </div>
                  <?php } else if(@$records->member_type == "5"){ ?>
                    <div class="col-md-6" id="shop_name" style="display: block;">
                      <label for="">Shop Name</label>
                      <input type="text" class="form-control" name="shop_name" placeholder="Enter Shop Name" value="<?php if(isset($records->member_shop_name)) echo $records->member_shop_name ?>">
                    </div>

                    <div class="col-md-6" id="shop_gst" style="display: block;">
                      <label for="">Shop Gst No</label>
                      <input type="text" class="form-control" name="shop_gst" placeholder="Enter Shop Gst No" value="<?php if(isset($records->member_shop_gst)) echo $records->member_shop_gst ?>">
                    </div>
                  <?php } else{ ?>

                    <div class="col-md-6" id="aadhar_number" style="display: none;">
                      <label for="">Aadhar Number</label>
                      <input type="text" class="form-control" name="share_aadhar" placeholder="Enter Shareholder Aadhar Number">
                    </div>

                    <div class="col-md-6" id="pan_number" style="display: none;">
                      <label for="">Pan Number</label>
                      <input type="text" class="form-control" name="share_pan" placeholder="Enter Shareholder Pan Number">
                    </div>


                    <div class="col-md-6" id="share_number" style="display: none;">
                      <label for="">No of Shares</label>
                      <input type="text" class="form-control" name="share_shares" placeholder="Enter Shareholder Number of Shares">
                    </div>


                    <div class="col-md-6" id="outlet_code" style="display: none;">
                      <label for="">Outlet Code</label>
                      <input type="text" class="form-control" name="outlet_code" placeholder="Enter Outlet Code">
                    </div>

                    <div class="col-md-6" id="shop_name1" style="display: none;">
                      <label for="">Shop Name</label>
                      <input type="text" class="form-control" name="shop_name" placeholder="Enter Shop Name">
                    </div>

                    <div class="col-md-6" id="shop_gst1" style="display: none;">
                      <label for="">Customer Gst</label>
                      <input type="text" class="form-control" name="shop_gsts" placeholder="Enter Customer Gst">
                    </div>

                    <div class="col-md-6" id="shop_name" style="display: none;">
                      <label for="">Shop Name</label>
                      <input type="text" class="form-control" name="shop_name" placeholder="Enter Shop Name" value="<?php if(isset($records->member_share_pan)) echo $records->member_share_pan ?>">
                    </div>

                    <div class="col-md-6" id="shop_gst" style="display: none;">
                      <label for="">Shop Gst No</label>
                      <input type="text" class="form-control" name="shop_gst" placeholder="Enter Shop Gst No" value="<?php if(isset($records->member_share_no_shares)) echo $records->member_share_no_shares ?>">
                    </div>
