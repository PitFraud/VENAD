    ...
    $(function() {
        ...
        $table = $('#classinfo_table').DataTable({
            ...
            "ajax": {
                ...
                "url": "<?php echo base_url(); ?>Member/get_shops/",
            ...
            "createdRow": function(row, data, index) {
                ...
                $('td', row).eq(13).html('<center><a href="<?php echo base_url(); ?>index.php/Member/getShopPaymentsDetails/' + data['member_id'] + '"><i class="fa fa-print iconFontSize-medium" ></i></a></center>');

                $('td', row).eq(14).html('<center><a href="<?php echo base_url(); ?>index.php/Member/edit/' + data['member_id'] + '"><i class="fa fa-edit iconFontSize-medium" ></i></a> &nbsp;&nbsp;&nbsp;<a onclick="return confirmDelete(' + data['member_id'] + ')"><i class="fa fa-trash-o iconFontSize-medium" ></i></a></center>');
