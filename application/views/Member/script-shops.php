    ...
    $(function() {
        ...
        $table = $('#classinfo_table').DataTable({
            ...
            "createdRow": function(row, data, index) {
                ...
                $('td', row).eq(11).html('<center><a href="<?php echo base_url(); ?>index.php/Member/getShopPaymentsDetails/'+data['member_id']+'"><i class="fa fa-print iconFontSize-medium" ></i></a></center>');
