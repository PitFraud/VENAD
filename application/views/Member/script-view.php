 ...
 $('#date').html(d);
  ...
  $(function () {
    ...
    $table = $('#classinfo_table').DataTable( {
        ...
        "bDestroy" : true,
        "ajax": {
            "url": "<?php echo base_url();?>Member/getview/",
            "type": "POST",
            "data" : function (d) {
...
//            $('td',row).eq(0).html(index+1);
      ...
      {
        //$('td',row).eq(1).html('Not uploaded');
         $('td',row).eq(2).html('<center><span style="color:blue;">Miscellenious</span></center>');
      }
      else if(data['member_type']=='1')
      {
        $('td',row).eq(2).html('<center><span style="color:red;">Share holder</span></center>');
      }

       else if(data['member_type']=='2')
      {
      $('td',row).eq(2).html('<center><span style="color:blue;">Outlet</span></center>');
      }
       else if(data['member_type']=='3')
      {
      $('td',row).eq(2).html('<center><span style="color:orange;">Outside Member</span></center>');
      }
       else if(data['member_type']=='4')
      {
      $('td',row).eq(2).html('<center><span style="color:yellow;">Other</span></center>');
      }
