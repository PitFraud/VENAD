            ...
            <div class="box">
                <div class="box-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="input-group">
                                <a href="<?php echo base_url(); ?>Member/add" class="btn btn-danger"><i class="fa fa-plus-square"></i> Add Shop</a>
                            </div>
                        </div>
                    </div>
                    <br>
                    ...
                    <table id="classinfo_table" class="table table-bordered table-striped">
                        <thead>
                            <tr>
                                ...
                                <th>SHOP NAME&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</th>
                                <th>SHOP GST&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;</th>
