...
<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="<?php echo base_url(); ?>CommissionDetails/"><i class="fa fa-dashboard"></i> Back to List</a></li>
      <li class="active"></li>
    </ol>
  </section>
                ...
                <div class="panel-body" style="font-weight:bold;">
                  <div class="form-group row">
                    <div class="col-md-6">
                      ...
                      <input type="text" class="form-control" name="commission_name" value="">
                    </div>
                    <div class="col-md-6">
                      <label class="fsize">Amount</label>
                      <input type="number" class="form-control" name="commission_amount" placeholder="Amount of commission" required>
                    </div>
                  </div>
                  <div class="form-group row">
                    <div class="col-md-6">
