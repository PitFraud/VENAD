          ...
          <table width="100%" style="border-right:1px solid #ddd;border-left: 1px solid #ddd;">
           ...
           <tr style="border-top: 1px solid #ddd;border-bottom:  1px solid #ddd;">
            ...
            <tr>
              ...
              <td style="border-right: 1px solid #ddd;padding: 10px;font-weight: bold;"><?php echo strtoupper($records[$i]->hsn); ?></td>
           ...
           <div class="row">
             <div class="col-md-6">
               ...
               <tr style="font-weight: bold;height:120px;">
                 <td style="border-right: 1px solid #ddd;padding: 10px;"><?php echo $cgst+$cgst; ?>%</td>
                 <td style="border-right: 1px solid #ddd;padding: 10px;"><i class="fa fa-inr"></i><?php echo $sum+$cgst_amt+$cgst_amt ?></td>
                 <td style="border-right: 1px solid #ddd;padding: 10px;"><?php echo $cgst; ?>%</td>
                 <td style="border-right: 1px solid #ddd;padding: 10px;"><?php echo $cgst; ?>%</td>
               </tr>
                </table>
             </div>
