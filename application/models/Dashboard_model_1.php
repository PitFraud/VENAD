...
public function getallotment()
	...
	public function get_notifications(){
		$notifications=[];
		$other_notifications=$this->db->select('*,DATE_SUB(reminder_date,INTERVAL 2 DAY) as beforetwodays')
		->order_by('reminder_date','ASC')->get('tbl_reminders');
		$notifications['reminders']=$other_notifications;
