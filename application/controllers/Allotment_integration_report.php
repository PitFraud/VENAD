...
class Allotment_integration_report extends MY_Controller {
	...
	public function __construct() {
		...
		$this->load->model('Allotment_integration_model');
		$this->load->model('Allotment_model');
	}
	public function index()
	{
		$template['notifications']=$this->General_model->get_notifications();
		$template['body'] = 'Allotment_integration_report/list';
		$template['script'] = 'Allotment_integration_report/script';
    ...
    public function get(){
		...
		$data = $this->Allotment_integration_model->getSaleReport($param);
